...
//    @Test
    public static void  Signs()
    {
       // System.out.println( "Hello World!" );  
        ...
        String patternsF  = new String("<xml version=1.0 encoding=UTF-8><attempt class=frames><alias width=30px>Trials</alias></attempt><parse id=tracks><alias height=40px>plans</alias></parse>") ; //( "<groupId>com.moderneinstein.logical.algorithms</groupId><artifactId>xml-parser</artifactId><version>2.4</version><name>xml-parser</name>") ;  
